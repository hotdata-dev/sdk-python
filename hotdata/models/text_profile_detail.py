...
class TextProfileDetail(BaseModel):
    """
    ...
    min_length: Annotated[int, Field(strict=True, ge=0)] = Field(description="Shortest string length in the column")
    __properties: ClassVar[List[str]] = ["avg_length", "max_length", "min_length"]
