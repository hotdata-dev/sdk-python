...
class NumericProfileDetail(BaseModel):
    """
    ...
    min: StrictStr = Field(description="Minimum value (string to preserve precision for large integers and decimals)")
    __properties: ClassVar[List[str]] = ["max", "mean", "min"]
