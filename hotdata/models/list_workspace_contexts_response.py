...
class ListWorkspaceContextsResponse(BaseModel):
    """
    Response body for GET `/v1/context`.
    """ # noqa: E501
    contexts: List[WorkspaceContextEntry]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "contexts": [WorkspaceContextEntry.from_dict(_item) for _item in obj["contexts"]] if obj.get("contexts") is not None else None
        })
        return _obj
