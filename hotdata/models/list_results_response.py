...
class ListResultsResponse(BaseModel):
    ...
    """ # noqa: E501
    count: Annotated[int, Field(strict=True, ge=0)] = Field(description="Number of results returned in this response")
    has_more: StrictBool = Field(description="Whether there are more results available after this page")
    ...
    __properties: ClassVar[List[str]] = ["count", "has_more", "limit", "offset", "results"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [ResultInfo.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
