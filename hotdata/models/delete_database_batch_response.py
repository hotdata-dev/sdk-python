...
class DeleteDatabaseBatchResponse(BaseModel):
    """
    Response body for DELETE /databases/bulk/{batch_id}.
    """ # noqa: E501
    batch_id: StrictStr
    deleted_count: StrictInt = Field(description="How many databases were removed.")
    __properties: ClassVar[List[str]] = ["batch_id", "deleted_count"]
