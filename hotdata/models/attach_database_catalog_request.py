...
class AttachDatabaseCatalogRequest(BaseModel):
    """
    Request body for POST /databases/{database_id}/catalogs
    """ # noqa: E501
    alias: Optional[StrictStr] = Field(default=None, description="Optional alias under which this catalog is reachable inside the database. When omitted, it is reachable by the connection's name.")
    connection_id: StrictStr
    __properties: ClassVar[List[str]] = ["alias", "connection_id"]
