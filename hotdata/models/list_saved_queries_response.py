...
class ListSavedQueriesResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["count", "has_more", "limit", "offset", "queries"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "queries": [SavedQuerySummary.from_dict(_item) for _item in obj["queries"]] if obj.get("queries") is not None else None
        })
        return _obj
