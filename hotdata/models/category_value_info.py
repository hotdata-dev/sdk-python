...
class CategoryValueInfo(BaseModel):
    """
    A distinct value with its frequency count, used in categorical profiles.
    """ # noqa: E501
    count: Annotated[int, Field(strict=True, ge=0)] = Field(description="Number of occurrences")
    value: Optional[StrictStr] = Field(default=None, description="The distinct value (as a string, or null)")
