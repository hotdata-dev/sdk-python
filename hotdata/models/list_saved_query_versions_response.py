...
class ListSavedQueryVersionsResponse(BaseModel):
    """
    ...
    versions: List[SavedQueryVersionInfo]
    __properties: ClassVar[List[str]] = ["count", "has_more", "limit", "offset", "saved_query_id", "versions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "versions": [SavedQueryVersionInfo.from_dict(_item) for _item in obj["versions"]] if obj.get("versions") is not None else None
        })
        return _obj
