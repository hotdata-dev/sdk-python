...
class ListDatabaseContextsResponse(BaseModel):
    """
    Response body for GET `/v1/databases/{database_id}/context`.
    """ # noqa: E501
    contexts: List[DatabaseContextEntry]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "contexts": [DatabaseContextEntry.from_dict(_item) for _item in obj["contexts"]] if obj.get("contexts") is not None else None
        })
        return _obj
