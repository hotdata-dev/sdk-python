...
class WorkspaceContextApi:
    ...
    def delete_workspace_context(
        ...
        _param = self._delete_workspace_context_serialize(
            name=name,
    ...
    @validate_call
    def delete_workspace_context_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="Context key: same character rules as a dataset table name (letter or underscore first; no hyphens)")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_workspace_context_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="Context key: same character rules as a dataset table name (letter or underscore first; no hyphens)")],
        _request_timeout: Union[
            None,
    ...
    def _delete_workspace_context_serialize(
        self,
        name,
        _request_auth,
        _content_type,
