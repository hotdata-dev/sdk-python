...
class ResultsApi:
    ...
    def get_result_handler(
        ...
        _param = self._get_result_handler_serialize(
            id=id,
    ...
    @validate_call
    def get_result_handler_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Result ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_result_handler_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Result ID")],
        _request_timeout: Union[
            None,
    ...
    def _get_result_handler_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def list_results_handler(
        ...
        _param = self._list_results_handler_serialize(
            limit=limit,
            offset=offset,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def list_results_handler_with_http_info(
        self,
        limit: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Maximum number of results (default: 100, max: 1000)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Pagination offset (default: 0)")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def list_results_handler_without_preload_content(
        self,
        limit: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Maximum number of results (default: 100, max: 1000)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Pagination offset (default: 0)")] = None,
        _request_timeout: Union[
    ...
    def _list_results_handler_serialize(
        self,
        limit,
        offset,
        _request_auth,
