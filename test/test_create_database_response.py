...
class TestCreateDatabaseResponse(unittest.TestCase):
    """CreateDatabaseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateDatabaseResponse:
        ...
        # uncomment below to create an instance of `CreateDatabaseResponse`
        """
    ...
    def testCreateDatabaseResponse(self):
        """Test CreateDatabaseResponse"""
