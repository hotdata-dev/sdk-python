...
class TestAttachDatabaseCatalogRequest(unittest.TestCase):
    """AttachDatabaseCatalogRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttachDatabaseCatalogRequest:
        """Test AttachDatabaseCatalogRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttachDatabaseCatalogRequest`
        """
    ...
    def testAttachDatabaseCatalogRequest(self):
        """Test AttachDatabaseCatalogRequest"""
