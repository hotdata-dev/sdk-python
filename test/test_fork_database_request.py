...
class TestForkDatabaseRequest(unittest.TestCase):
    """ForkDatabaseRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ForkDatabaseRequest:
        """Test ForkDatabaseRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ForkDatabaseRequest`
        """
    ...
    def testForkDatabaseRequest(self):
        """Test ForkDatabaseRequest"""
